...
<table id="mainbodytable">
  ...
  <tr>
    <td id="indexrightbox_subnav"><h2><font face="Verdana, Arial, Helvetica, sans-serif">Add
          your comments to our guestbook</font></h2>
          ...
          <table id="contactform">
            ...
            <tr>
              <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Security
                  Code:</font></td>
              <td><img src="<?php echo "/secureform/" . $secureimage; ?>" alt="Security Code" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Type
                  Security Code (lowercase):</font></td>
            ...
            <tr>
              <td colspan="2"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Your
                  Comments:</font><br />
